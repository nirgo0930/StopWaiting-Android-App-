...
import com.example.stopwaitingadmin.databinding.AdminMainBinding;
...
//        ToLoginIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP);
        ...
        binding.btnWaitList.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.btnReportedUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
